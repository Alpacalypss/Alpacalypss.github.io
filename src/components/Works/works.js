  ...
  return (
    <section id="works">
      ...
      <span className="worksDescription">
        ...
        functionalities with pixel perfect accuracy. Below are some screenshots
        of projects I have worked on. If you want to check out any of the code
        behind my work, click the button to view my public github repositories.
      </span>
      ...
      <a href="https://github.com/Alpacalypss" target="_blank" rel="noreferrer">
